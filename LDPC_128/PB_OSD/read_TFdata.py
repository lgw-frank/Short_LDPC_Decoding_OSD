...
# training dataset
      dataset_test = get_dataset(file_name,code_length)        
      ...
      dataset_test = dataset_test.batch(batch_size,drop_remainder=False).prefetch(buffer_size=tf.data.experimental.AUTOTUNE)
      return dataset_test
